...
** svn访问github
很多时候我更需要svn，因为我的项目基本上是个人的项目，并不需要分布式管理，用svn操作简单多了。幸运的是github支持svn，不幸的是它不支持证书登录。
: svn co --username wuyao721@163.com --password mypassword https://github.com/wuyao721/51docs/trunk 51docs
