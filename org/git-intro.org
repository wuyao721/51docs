...
* github
 [[https://github.com][github]] 是一个网站，同时也是一个项目仓库。首先，我们在网站上注册一个帐号，然后就可以在上面免费创建开源项目。利用git这个分布式版本管理系统，我们可以吸引到更多的人关注，加入我们的项目。
...
** github的版本库
更新本地版本库后，我们就可以将推送到github的版本库，合并到master或者其它分支。
...
| 指令         | 中文版               | 说明                        |
|--------------+----------------------+-----------------------------|
| git clone .. | git 克隆 ..          | 克隆嘛，相当于svn的checkout |
| git          | git 在这里创建新版本 |                             |
| git          | git 在这里创建新版本 |                             |
| git sync ..  | git 同步 ..          |                             |
| git commit .. | git 提交 ..          | 提交到本地版本库，                   |
